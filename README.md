...
![C++ Tests](https://img.shields.io/badge/C%2B%2B%20Tests-PASSED-brightgreen) ![Swift Tests](https://img.shields.io/badge/Swift%20Tests-PASSED-brightgreen)
...
*Last updated: 2025-07-24 09:53:00 UTC*
...
To run tests manually, use the provided scripts:
...
**Requirements**: CMake 3.14+, C++17 compiler, Swift 5.7+
